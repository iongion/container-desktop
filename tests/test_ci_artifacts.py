from support.ci_artifacts import parse_appx_version, select_windows_artifact


def _artifact(artifact_id, name="container-desktop-windows", expired=False, run_id=None):
    return {
        "id": artifact_id,
        "name": name,
        "expired": expired,
