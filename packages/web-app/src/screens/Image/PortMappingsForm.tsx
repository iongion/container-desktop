...
export const PortMappingForm: React.FC<PortMappingFormProps> = ({ action, disabled, portMapping, portMappingIndex }) => {
...
export const PortMappingsForm: React.FC<PortMappingsFormProps> = ({ disabled, portMappings }) => {
  ...
  const onPortMappingFormAction = useCallback<PortMappingFormActionHandler>((action, portMapping) => {
    if (action.data === "add") {
