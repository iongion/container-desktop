  ...
  return (
    <div className="AppScreen" data-screen={ID}>
      ...
      <div className="AppScreenContent">
        <HTMLTable interactive condensed striped className="AppDataTable" data-table="pods">
          <thead>
            <tr>
              <th data-column="Name"><AppLabel iconName={IconNames.CUBE} text={t("Name")} /></th>
              <th data-column="Containers" title={t("Count of containers using the pod")}><AppLabel iconName={IconNames.BOX} /></th>
            ...
            {pods.map((pod) => {
              ...
              return (
                <tr key={pod.Id} data-pod={pod.Id} data-state={pod.Status}>
                  ...
                  <td><Code>{pod.Id.substring(0, 12)}</Code></td>
