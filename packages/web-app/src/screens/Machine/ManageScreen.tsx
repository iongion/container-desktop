  ...
  return (
    <div className="AppScreen" data-screen={ID}>
      ...
      <div className="AppScreenContent">
        <HTMLTable interactive condensed striped className="AppDataTable" data-table="machines">
          <thead>
            <tr>
              <th data-column="Name"><AppLabel iconName={IconNames.HEAT_GRID} text={t("Name")} /></th>
              <th data-column="VMType">{t("VM Type")}</th>
              <th data-column="Active">{t("Active")}</th>
              <th data-column="Running">{t("Running")}</th>
              <th data-column="LastUp"><AppLabel iconName={IconNames.CALENDAR} text={t("Last Up")} /></th>
