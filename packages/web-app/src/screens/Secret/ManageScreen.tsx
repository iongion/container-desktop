  ...
  return (
    <div className="AppScreen" data-screen={ID}>
      ...
      <div className="AppScreenContent">
        <HTMLTable interactive condensed striped className="AppDataTable" data-table="secrets">
          <thead>
            <tr>
              <th data-column="Name"><AppLabel iconName={IconNames.KEY} text={t("Name")} /></th>
              <th data-column="Id"><AppLabel iconName={IconNames.BARCODE} text={t("Id")} /></th>
              <th data-column="Updated"><AppLabel iconName={IconNames.CALENDAR} text={t("Updated")} /></th>
