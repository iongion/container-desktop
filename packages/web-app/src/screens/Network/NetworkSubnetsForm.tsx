...
export const NetworkSubnetForm: React.FC<NetworkSubnetFormProps> = ({ action, disabled, networkSubnet, networkSubnetIndex }) => {
...
export const NetworkSubnetsForm: React.FC<NetworkSubnetsFormProps> = ({ disabled, subnets }) => {
  ...
  const onNetworkSubnetFormAction = useCallback<NetworkSubnetFormActionHandler>((action, networkSubnet) => {
    if (action.data === "add") {
