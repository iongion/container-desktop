...
export const ScreenHeader: React.FC<ScreenHeaderProps> = ({ searchTerm, onSearch, onSearchTrigger, withSearchTrigger, registry, listRoutePath, listRouteIcon, rightContent }) => {
  ...
  const onSearchTriggered = useCallback((e) => {
    if (onSearchTrigger) {
