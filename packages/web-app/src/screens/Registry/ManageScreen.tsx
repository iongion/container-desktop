...
export const Screen: AppScreen<ScreenProps> = () => {
  ...
  const onSearchTrigger = useCallback(async (filters: RegistrySearchFilters, event: MouseEvent<HTMLElement, MouseEvent>) => {
  ...
  const onCurrentRegistryChange = useCallback((e: FormEvent<HTMLInputElement>) => {
  ...
  switch (state) {
    ...
    case "state.looked-up":
      content = searchResults.length === 0 ? (
        ...
        <HTMLTable interactive condensed striped className="AppDataTable" data-table="search.results">
          <thead>
            <tr>
              <th data-column="Name"><AppLabel iconName={IconNames.BOX} text={t("Image")} /></th>
              <th data-column="Registry"><AppLabel iconPath={mdiCubeUnfolded} text={t("Registry")} /></th>
              <th data-column="Stars"><AppLabel iconName={IconNames.STAR} /></th>
            </tr>
          </thead>
          <tbody>
    ...
    <div className="AppScreen" data-screen={ID}>
      ...
      <div className="AppScreenContent">
        ...
        <div className="AppScreenContentView" data-column="right">
          <HTMLTable condensed striped className="AppDataTable" data-table="registries">
            <thead>
              <tr>
                <th data-column="name">
