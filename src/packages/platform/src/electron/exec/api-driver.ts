...
import type { ApiDriverConfig } from "@/container-client/types/host";
...
// reuse them; the Command facade does NOT re-export them — they were never part of the public surface.
