...
const COMMAND_TO_METHOD: Record<string, string> = {
  ...
  // WorkspaceService (built) — the confined workspace backing IWorkspaceAccess. Confinement is enforced
  // in Go, mirroring the Rust workspace_* commands; this table only names the binding.
  workspace_root: "main.WorkspaceService.Root",
  workspace_read: "main.WorkspaceService.ReadFile",
  workspace_write: "main.WorkspaceService.WriteFile",
  workspace_edit: "main.WorkspaceService.EditFile",
  workspace_list: "main.WorkspaceService.List",
  workspace_stat: "main.WorkspaceService.Stat",
  workspace_remove: "main.WorkspaceService.Remove",
  workspace_glob: "main.WorkspaceService.Glob",
  workspace_grep: "main.WorkspaceService.Grep",
  workspace_exec: "main.WorkspaceService.Exec",
