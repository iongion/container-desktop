...
export interface WailsMessageBusDeps {
...
export function createMessageBus(deps: WailsMessageBusDeps): IMessageBus {
...
async function openFileSelector(deps: WailsMessageBusDeps, options: any): Promise<unknown> {
...
async function openTerminal(deps: WailsMessageBusDeps, options: any): Promise<boolean> {
