...
import { __setLoggerLevelForTests, createLogger, registerLoggerBackend } from "@/logger";

afterEach(() => registerLoggerBackend(null));

// Proves the persistence backend is swappable behind the @/logger port (the Tauri seam): a fake backend
