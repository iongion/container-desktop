...
import { Button, AnchorButton, ButtonGroup, MenuItem, Intent } from "@blueprintjs/core";
...
export const ActionsMenu: React.FC<ActionsMenuProps> = ({ container, expand, isActive, withOverlay }) => {
  ...
  const kubeDisabledTitle = isKubeAvailable
    ? ""
    : t("Not available when using {{currentAdapter}} engine", { currentAdapter });
