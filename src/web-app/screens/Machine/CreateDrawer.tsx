...
import { Button, ButtonGroup, Classes, Drawer, DrawerSize, FormGroup, InputGroup, Intent, NumericInput, ProgressBar } from "@blueprintjs/core";
...
export const CreateDrawer: React.FC<CreateDrawerProps> = ({ onClose }: CreateDrawerProps) => {
  ...
  return (
    <Drawer className="AppDrawer" title={t("Create new machine")} icon={IconNames.PLUS} usePortal size={DrawerSize.SMALL} onClose={onDrawerClose} isOpen hasBackdrop={false}>
