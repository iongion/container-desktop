...
import { collectDevApiKeysFromEnv } from "@/ai-system/runtimes/devKeys";
// project
...
import { createLogger, getLevel, registerLoggerBackend } from "@/platform/logger";
...
let aiSystemHost: AISystemHost | undefined;
...
async function bootstrap() {
  ...
  // renderer→main bridge BEFORE the first window is created. Console stays with the @/platform/logger façade;
