...
// router. Extracted as a pure helper so it stays hermetically testable — bridge.ts pulls the full Tauri API
...
// Under Tauri the app origin is itself http(s) (`http://tauri.localhost`), so pathTo emits
