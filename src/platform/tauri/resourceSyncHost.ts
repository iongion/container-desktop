// In-process RESOURCE_SYNC hub for the Tauri realm. Under Tauri the engine service and the renderer share ONE
...
//
// Deliberately Tauri-agnostic (no @tauri-apps imports) so it is unit-testable under Vitest; bridge.ts is the only
// place that ties it to the Tauri window and the Rust-backed Command.
