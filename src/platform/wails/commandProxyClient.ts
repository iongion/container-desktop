// Wails-side client for Command.ProxyRequest. This is the named counterpart to
// platform/electron/commandProxyClient.ts; it speaks to Go proxy commands instead of Electron main IPC.
