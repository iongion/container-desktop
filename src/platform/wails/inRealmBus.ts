// The Electron main↔renderer IPC collapse for the single-realm Wails shell. Under Wails a host-side broker
...
// and aiSystemHost.ts — it lives here once. Wails-agnostic (no @wailsio/runtime) so both hosts stay unit-testable.
