...
describe("Tauri portable package parity", () => {
  ...
  it("exposes Tauri portable scripts for the zip and tar.gz artifacts", () => {
    expect(rootPkg.scripts["package:tauri:win_x64"]).toContain("package:tauri:win_store");
    expect(rootPkg.scripts["package:tauri:win_x64"]).toContain("package:tauri:win_zip:x64");
    expect(rootPkg.scripts["package:tauri:win_arm"]).toContain("package:tauri:win_zip:arm64");
