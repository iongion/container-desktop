...
openssl req -subj '/CN=iongion.podman-desktop-companion.local' -config devtest.extensions -x509 -newkey rsa:4096 -keyout selfSignedKey.pem -out selfSigned.pem -days 365 -passout env:PASSPHRASE
