...
export const ActionsMenu: React.FC<ActionsMenuProps> = ({ container, expand, isActive }) => {
  ...
  const containerStop = useStoreActions((actions) => actions.containerStop);
  const containerRestart = useStoreActions((actions) => actions.containerRestart);
  const containerRemove = useStoreActions((actions) => actions.containerRemove);
  const containerConnect = useStoreActions((actions) => actions.containerConnect);
