...
export const MachineActionsMenu: React.FC<ActionsMenuProps> = ({ machine, withoutCreate }) => {
  ...
  const machineFetch = useStoreActions((actions) => actions.machineFetch);
  const machineRemove = useStoreActions((actions) => actions.machineRemove);
  const machineStop = useStoreActions((actions) => actions.machineStop);
  const machineRestart = useStoreActions((actions) => actions.machineRestart);
  const machineConnect = useStoreActions((actions) => actions.machineConnect);
